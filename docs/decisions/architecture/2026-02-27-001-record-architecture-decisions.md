...
Architectural decisions are scattered across project documentation, implementation plans, specification files, and git history. There is no single place to find *why* a decision was made or what alternatives were rejected. New contributors (human or AI) must reverse-engineer rationale from code and comments.
